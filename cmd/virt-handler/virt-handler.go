...
func (app *virtHandlerApp) Run() {
	...
	// Not labeling nodes because CH Libvirt driver doesn't support listing domain capabilities
	if virtconfig.IsAMD64(runtime.GOARCH) && false { // TODO Hermes MSHV/KVM.
